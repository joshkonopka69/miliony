-- ============================================
-- EMERGENCY FIX - Simplify ALL RLS Policies
-- ============================================
...
-- This is the critical one for profile photos!
...
-- Simple SELECT policy - see friendships where you're involved
...
-- Simple INSERT policy - create friendships as either user_id or friend_id
...
-- Simple UPDATE policy - update friendships where you're involved
...
-- Simple DELETE policy - delete friendships where you're involved
...
SELECT 'USER_FRIENDSHIPS TABLE:' as info;
