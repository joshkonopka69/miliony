...
-- This will fix all foreign key constraints and triggers
...
-- ============================================
-- 4. RENAME CHAT TABLE TO MATCH BACKEND
-- ============================================
...
-- ============================================
-- 5. CREATE EVENT_MESSAGES TABLE (if it doesn't exist)
-- ============================================
...
-- ============================================
-- 6. CREATE EVENT_PARTICIPANTS TABLE (if it doesn't exist)
-- ============================================
...
-- This migration:
-- ✅ Dropped all problematic triggers and functions
-- ✅ Removed all foreign key constraints that were causing issues
-- ✅ Fixed events table structure (removed creator_id, added all columns)
