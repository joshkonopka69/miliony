-- FINAL CRASH FIX - Handles existing policies
...
-- Step 4: Create sample events (this fixes schema cache issue)
...
-- Step 6: Create chat messages (this fixes empty chat issue)
...
-- Step 10: Test event creation (should work now)
INSERT INTO events (title, sport_type, max_participants, latitude, longitude, created_by, scheduled_datetime, status) VALUES
